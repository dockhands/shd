/**
 * by Dan Hawkins, but adapted (ie taken) from Adrian Cooney; http://dunxrion.github.io
 * http://dockhands.github.io
 * Sept 17th made for Shit Harper Does
 */
...
(function(console) {
	...
	var memes = {"Economy":"img/01_man.png", "Women":"img/02_surfer.png", "Guy":"img/03_guy.png", "Family":"img/04_bbq.png","Climate":"img/05_mountains.png", "Sports":"img/06_yoga.png","Friends":"img/07_tug.png","Children":"img/08_kid.png",};


// [img]http://i.imgur.com/hnnkCJp.jpg?1[/img]
	...
	function drawMemeText(ctx, type, text, width, y) {
		...
		if(text.length < 20) {
			var val = Math.max(0, text.length),
				size = 70 + (val * - 3);
   ...
   // ctx.lineJoin="miter"; //Experiment with "bevel" & "round" for the effect you want!
	...
	console.meme = function(upper, lower, image, width, height) {
		...
		img.onload = function() {
			...
			drawMemeText(ctx, "upper", upper, _w-95, 50); //upper
			drawMemeText(ctx, "lower", lower, _w-95, _h - 50); //upper
